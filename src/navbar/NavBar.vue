  ...
  <nav class="bg-transparent">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
      <RouterLink to="/" class="flex items-center logoBrand" style="background-color: white">
        <img src="../assets/resource/images/landing/logo.png" class="lg:h-16 md:h-12 sm:h-10 h-10 m-4"
          alt="Flowbite Logo" />
      </RouterLink>
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul
          ...
          <template v-if="isOnLanding">
            ...
            <li>
              <a href="#hero6"
                class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 transition hover:scale-105">Pricing</a>
            </li>
            <li>
              <a href="#"
                class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 transition hover:scale-105">FAQ</a>
            </li>
            <li>
